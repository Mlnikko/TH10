...
[CustomEditor(typeof(GameConfigChecklist))]
public class GameConfigChecklistEditor : GameConfigEditor
{
    const string SEARCH_PATH = "Assets/Configs";

    public override void OnInspectorGUI()
    {
        // 先调用基类（显示 Addressable Key UI）
        base.OnInspectorGUI();
    ...
    {
        var checklist = (GameConfigChecklist)target;
